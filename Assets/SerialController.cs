...
public class SerialController : MonoBehaviour
{
    ...
    public string portName = "COM16"; // COM16 for RS232, COM6 for USB

    [Tooltip("Baud rate that the serial device is using to transmit data.")]
    public int baudRate = 115200; // was 9600
    ...
    public int maxUnreadMessages = 10000;
    ...
    void Update()
    {
        ...
        if (ReferenceEquals(message, SERIAL_DEVICE_CONNECTED))
            ...
            //messageListener.SendMessage("OnTargetArrived", message); */
    }
