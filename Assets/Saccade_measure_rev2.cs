...
//
//  Revised by Kevin Mai at Kojima Lab, UW OTO.
//  25th of August 2023.
//
...
//      - VIVE Calibration:       Performed in the first place.
...
namespace Test120FPS{
    public class Saccade_measure_rev2 : MonoBehaviour
    {
        ...
        public string EyeDataCOMPortHorz = "COM6"; // COM16 for RS232, COM6 for USB
        ...
        {           
            ...
            {
                _serialPort = new SerialPort(EyeDataCOMPortHorz); //hard coded COM6
            ...
            if (enablePortVertical)
            {
                ...
                _serialPortVertical.ReadTimeout = 1000;
                _serialPortVertical.WriteTimeout = 1000;
            ...
            while (cnt_callback < maxframe_count)
            {
                ...
                if (error == ViveSR.Error.WORK)
                {
                    ...
                    string value =
                        ...
                        gaze_origin_R.x.ToString() + "," + //use this variable for right eye
                        gaze_origin_R.y.ToString() + "," +
                        gaze_origin_R.z.ToString() + "," +*/

                        gaze_direct_L.x.ToString();/* "," + // send to teensy
...
/*                     valueTime = 
                    ...
                    UnityEngine.Debug.Log("EyeH:" + gaze_direct_L.x + "EyeV:" + gaze_direct_L.y);
                    ...
                    //UnityEngine.Debug.Log(gaze_direct_L.y);
                    //Debug.Log("Left eye (mm): " + eyeData.verbose_data.left.gaze_origin_mm);
        ...
        void Update()
        {   
            //UnityEngine.Debug.Log("Press space key to quit.");
/*             while (!Input.GetKeyDown(KeyCode.Space))// to exit unity, press space
            {
                if (UnityEditor.EditorApplication.isPlaying)
            {
                UnityEditor.EditorApplication.isPlaying = false;    // Stops Unity editor.
